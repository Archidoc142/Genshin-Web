...
<h2 class="inline-block title">Tous les armes 5★</h2>
<a>- en ordre de sortie</a>

<div class="flex containerObj">
    <?php
        foreach($armes as $v){
            echo '<a href="arme/' . $v->get_nom() . '.php" class="containerArme c5" draggable="false"><img src="img/arme/' . $v->get_nom() . '.png" alt="image" draggable="false"><p>' . $v->get_nom() . '</p><img src="img/icon/five_stars.png" alt="image" draggable="false"></a>';
        }
    ?>
</div>
