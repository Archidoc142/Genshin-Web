...
<div class="flex containerObj"> <!-- À partir d'un certain index pour les armes 4 étoiles -->
    <?php
        foreach($artefacts as $v){
            echo '<a href="' . $v->get_nom() . '.php" class="containerArme c5" draggable="false"><img src="img/artefact/' . $v->get_nom() . '.png" alt="image" draggable="false"><p>' . $v->get_nom() . '</p><img src="img/icon/five_stars.png" alt="image" draggable="false"></a>';
        }
    ?>
</div>
