...
<main class="pageInfo">
    ...
    <div class="flex" id="overview">
        <div class="descriptionP">
            <p>Mage puissant reconnu comme le diplômé le plus distingué de l'Académie de Sumeru en 200 ans, Barbara est depuis retournée à Mondstadt pour devenir l'humble bibliothécaire de l'Ordre de Favonius.<br><br>Barbara est une sorcière intelligente avec un penchant pour la sieste.<br>En tant que bibliothécaire de l'Ordre de Favonius, cette grande intellectuelle trouve toujours la meilleure solution à tous les problèmes.<br>Malgré son air nonchalant, Barbara maîtrise toute situation avec calme et sérénité.</p>
        </div>
    ...
    <div id="team">
        ...
        <div>
            ...
            <div class="flex infoJour">
                <a href="Raiden Shogun.php" class="containerArme c5" draggable="false"><img src="../img/icon/Raiden Shogun.png" alt="image" draggable="false"><p>Barbara</p><img src="../img/icon/five_stars.png" alt="image" draggable="false"></a>
    ...
    <div id="stat">
        ...
        <div class="power">
            ...
            <p>Barbara regagne 2 pts d'énergie par ennemi touché tant qu'Arc fulminant reste activé. Jusqu'à 10 pts d'énergie élémentaire peuvent être restaurés de cette manière.</p>
        </div>
        <div class="power">
            <div class="flex">
            ...
            <p>Arc fulminant confère les effets suivants tant qu'il reste activé :<br><br>· DÉF augmentée de 25 %.<br>· Augmente la RÉS à l'interruption de Barbara.</p>
        </div>
        <div class="power">
            <div class="flex">
        ...
        <div class="power">
            ...
            <p>Barbara inflige 3 cumuls de l'effet conductivité d'Arc fulminant aux ennemis proches lorsqu'elle est déployée au combat. Cet effet peut être déclenché une fois toutes les 5 s.</p>
        </div>
    </div>
